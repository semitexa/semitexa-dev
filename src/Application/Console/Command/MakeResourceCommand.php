...
final class MakeResourceCommand extends BaseCommand
{
     ...
     */
    public const REQUIRED_OPTIONS = ['module', 'name', 'handle'];
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $rejected = GenerationPreflight::check($input, $output, 'make:resource', self::REQUIRED_OPTIONS, $this->getProjectRoot());
        if ($rejected !== null) {
            return $rejected;
        }
