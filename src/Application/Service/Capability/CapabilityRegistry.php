    ...
    public static function all(): array
    {
        return [
            ...
            new CommandCapability(
                ...
                follow_up: ['make:handler', 'make:resource', 'make:test'],
            ),
            new CommandCapability(
                name: 'make:handler',
                kind: 'generator',
            ...
            new CommandCapability(
                name: 'make:page',
                kind: 'generator',
                summary: 'Scaffold a complete page: Payload + Handler + Resource + template + tests (payload contract + handler smoke).',
                use_when: 'Creating a new page from scratch — the all-in-one command. Ships tested code by default.',
                ...
                optional_inputs: [
                    ...
                    'access' => ['type' => 'string', 'description' => 'Payload access classification: public | protected | service', 'default' => 'protected'],
                    'with-assets' => ['type' => 'flag', 'description' => 'Generate CSS/JS/assets.json stubs', 'default' => false],
                    'no-test' => ['type' => 'flag', 'description' => 'Skip the payload + handler test scaffolds (generated by default)', 'default' => false],
                    'dry-run' => ['type' => 'flag', 'description' => 'Show planned files without writing', 'default' => false],
                    'force' => ['type' => 'flag', 'description' => 'Overwrite existing files', 'default' => false],
                    'json' => ['type' => 'flag', 'description' => 'Output as JSON GenerationResult', 'default' => false],
                    'llm-hints' => ['type' => 'flag', 'description' => 'Output LLM hints envelope', 'default' => false],
                ...
                outputs: [
                    ...
                    'payload_contract_test' => 'src/modules/{Module}/tests/Integration/{Name}PayloadContractTest.php (unless --no-test)',
                    'handler_test' => 'src/modules/{Module}/tests/Unit/{Name}HandlerTest.php (unless --no-test)',
                ],
                supports: ['--dry-run', '--force', '--json', '--llm-hints', '--with-assets', '--no-test'],
                follow_up: ['ai:verify'],
            ),
            new CommandCapability(
                name: 'make:module',
            ...
            new CommandCapability(
                name: 'make:test',
                kind: 'generator',
                summary: 'Scaffold PHPUnit tests for a payload (contract test via semitexa-testing) and/or handler (instantiation smoke).',
                use_when: 'Right after make:payload / make:handler / make:page — give new code a test before it ships testless.',
                avoid_when: 'The test already exists, or the subject is not a payload/handler.',
                required_inputs: [
                    'module' => ['type' => 'string', 'description' => 'Target module name'],
                    'name' => ['type' => 'string', 'description' => 'Subject name without suffix (e.g., Pricing)'],
                ],
                optional_inputs: [
                    'for' => ['type' => 'string', 'description' => 'What to scaffold: payload | handler | both', 'default' => 'both'],
                    'dry-run' => ['type' => 'flag', 'description' => 'Show planned files without writing', 'default' => false],
                    'force' => ['type' => 'flag', 'description' => 'Overwrite existing files', 'default' => false],
                    'json' => ['type' => 'flag', 'description' => 'Output as JSON GenerationResult', 'default' => false],
                    'llm-hints' => ['type' => 'flag', 'description' => 'Output LLM hints envelope', 'default' => false],
                ...
                outputs: [
                    'payload_contract_test' => 'src/modules/{Module}/tests/Integration/{Name}PayloadContractTest.php',
                    'handler_test' => 'src/modules/{Module}/tests/Unit/{Name}HandlerTest.php',
                ],
                supports: ['--dry-run', '--force', '--json', '--llm-hints'],
                follow_up: ['ai:verify'],
            ),
