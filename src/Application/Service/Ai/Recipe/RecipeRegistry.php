...
final class RecipeRegistry
{
    ...
    private static function recipes(): array
    {
        return [
            new Recipe(
                id: 'refactor_existing_code',
                label: 'Refactor existing code',
                summary: 'Restructure, rename, split, or consolidate code that already exists. No new endpoint, no generator.',
                keywords: ['refactor', 'restructure', 'reorganize', 'cleanup', 'simplify', 'split', 'consolidate', 'inline', 'extract', 'move', 'untangle', 'dedupe', 'deduplicate', 'decouple'],
                verbs: ['refactor', 'restructure', 'reorganize', 'clean', 'simplify', 'split', 'consolidate', 'inline', 'extract', 'move', 'dedupe'],
                generator_chain: [],
                context_signals: [],
                arg_hints: [],
                default_risk: 'medium',
            ...
            new Recipe(
                id: 'audit_codebase',
                label: 'Audit or review a slice of the codebase',
                summary: 'Read-only assessment of an area — security, quality, conventions, deprecations. Produces findings, not code.',
                keywords: ['audit', 'review', 'assess', 'inventory', 'survey', 'inspect', 'check', 'evaluate', 'sweep'],
                verbs: ['audit', 'review', 'assess', 'inventory', 'survey', 'inspect', 'evaluate'],
                generator_chain: [],
                context_signals: [],
                arg_hints: [],
                default_risk: 'low',
            ...
            new Recipe(
                id: 'migrate_or_upgrade',
                label: 'Migrate or upgrade',
                summary: 'Schema migration, framework/package bump, API version move, or mass rewrite behind a new contract.',
                keywords: ['migrate', 'migration', 'upgrade', 'bump', 'port', 'rewrite', 'cutover', 'rollout', 'deprecate', 'sunset', 'backfill'],
                verbs: ['migrate', 'upgrade', 'bump', 'port', 'rewrite', 'cutover', 'deprecate'],
                generator_chain: [],
                context_signals: [],
                arg_hints: [],
                default_risk: 'high',
            ...
            new Recipe(
                id: 'document_or_explain',
                label: 'Document or explain',
                summary: 'Write or update technical documentation, or explain how something works. Does not produce runtime code.',
                keywords: ['document', 'documentation', 'docs', 'explain', 'write-up', 'describe', 'readme', 'guide', 'tutorial'],
                verbs: ['document', 'explain', 'describe', 'write', 'write-up'],
                generator_chain: [],
                context_signals: [],
                arg_hints: [],
                default_risk: 'low',
            ...
            new Recipe(
                ...
                label: 'Optimize performance or resource usage',
                summary: 'Profile, measure, and reduce latency / memory / CPU / IO. Change must be verified against a baseline.',
                keywords: ['optimize', 'performance', 'perf', 'latency', 'slow', 'fast', 'memory', 'cpu', 'profile', 'benchmark', 'cache', 'throughput'],
                verbs: ['optimize', 'profile', 'measure', 'benchmark', 'speed'],
                generator_chain: [],
                context_signals: [],
                arg_hints: [],
                default_risk: 'medium',
            ...
            new Recipe(
                id: 'unknown_task',
                label: 'Unknown task type — no recipe matched',
                summary: 'The classifier could not match the description to any known recipe. Proceed manually: decompose via ai:epic, use ai:ask for introspection, edit with Edit/Write, verify with ai:verify.',
                keywords: [],
                verbs: [],
                generator_chain: [],
                context_signals: [],
            ...
            new Recipe(
                ...
                arg_hints: [
                    ...
                    '--response' => 'Response class base name for the payload.',
                    '--payload' => 'Payload class base name for the handler.',
                    '--resource' => 'Response class base name for the handler.',
                    '--handle' => 'Render handle for the generated resource.',
                ],
                default_risk: 'low',
            ),
            new Recipe(
                ...
                arg_hints: [
                    ...
                    '--path'   => 'HTTP route path for the page.',
                    '--method' => 'HTTP method (e.g. GET).',
                ],
                default_risk: 'low',
            ),
            new Recipe(
                ...
                arg_hints: [
                    ...
                    '--execution' => 'Execution mode: Sync, Async, or Queued.',
                ],
                default_risk: 'low',
            ),
            new Recipe(
            ...
            new Recipe(
                ...
                arg_hints: [
                    ...
                    '--command-name' => 'Command CLI name (e.g. lint:foo or domain:action).',
